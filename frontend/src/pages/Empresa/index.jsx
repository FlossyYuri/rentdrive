...
import { estadosEmpresa, headersEmpresa, pacotesEmpresa, tiposEmpresa } from "../../constants/dictionary";
    ...
    if (usuario.funcao === 'vendedor')
      return [
        ...
        },
        {
          text: "Editar",
          onClick: () => {
            history.push(`/clientes/edit/${item.id}`);
          },
        },
      ]
    return [
      ...
      item.aprovado ?
        {
          text: "Reprovar",
          onClick: () => {
            APIKit.put(`/clientes/reprovar/${item.id}`)
          ...
          text: "Aprovar",
          onClick: () => {
            APIKit.put(`/clientes/aprovar/${item.id}`)
