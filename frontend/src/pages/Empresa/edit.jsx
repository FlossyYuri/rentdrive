      ...
      <form onSubmit={(e) => {
        ...
        <div className="card mb-3">
          ...
          <div className="flex flex-wrap gap-2">
            {tiposEmpresa.map((item) => (<RadioButton key={item.value} disabled name="tipo" label={item.label} selected={formik.values?.tipo} value={item.value}
              onChange={formik.handleChange} />))}
          </div>
        </div>
        <div className="card mb-3">
